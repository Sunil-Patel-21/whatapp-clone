...
const handleSave = async (field) => {
  ...
  const handleEmojiSelect = (emoji,field)=>{
    if(field === "name"){
      ...
      setAbout((prevAbout) => prevAbout + emoji);
      setShowAboutEmoji(false);
    }
  }
      ...
      >
        ...
        <div className='w-full rounded-lg p-6'>
          ...
          <div className='space-y-6'>
              <div className='flex flex-col items-center '>
                <div className='relative group'>
                  ...
                  <label 
                    ...
                    className='absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity duration-300'
                  >
            ...
            <div className={`relative p-4 ${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-black"} shadow-sm rounded-lg `}>
              <label htmlFor="about" className='block text-sm font-medium mb-1 text-gray-500 text-start'>About</label>
              <div className='flex items-center'>
                {isEditingAbout ? (
                  <input 
                    type="text" 
